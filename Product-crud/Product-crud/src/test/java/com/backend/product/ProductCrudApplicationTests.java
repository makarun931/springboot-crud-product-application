...
class ProductCrudApplicationTests {
	...
	public void testInsert() {
		Product product = new Product(3, "end cards", "value", 124, 24);
	...
	public void testGetProduct() {
		int id = 1617;
		ResponseEntity<?> response = productController.getProduct(id);
	...
	public void testUpdate() {
		Product product = new Product(2, "value", "end card", 124, 24);
